...
class _TeamChatScreenState extends State<TeamChatScreen> {
  ...
  Future<void> sendMessage() async {
    ...
    // SEND NOTIFICATIONS AFTER EMPLOYEE CHAT
    await notifyAllOnEmployeeChat(msg);
...
// NOTIFY ALL EMPLOYEES + ADMIN WHEN EMPLOYEE SENDS CHAT
  Future<void> notifyAllOnEmployeeChat(String message) async {

    try {

      // FETCH ALL EMPLOYEE TOKENS
      ...
      for (var doc in adminSnapshot.docs) {
        ...
        await PushNotificationService.sendNotification(
          ...
          body: "$employeeName sent: $message",
        );
      }
